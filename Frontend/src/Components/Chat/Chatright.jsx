...
const Chatright = () => {
  ...
  return (
    <div className='bg-black border-l border-gray-800 flex-1 flex flex-col h-screen'>
      {/* Header */}
      <div className='flex justify-between px-6 py-4 border-b border-gray-800 bg-black'>
